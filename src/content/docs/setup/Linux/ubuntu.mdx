...
I tend to set up a simple cronjob to keep Rust up to date. While a project might have a minimum supported reason for whatever reason there's not really any good reason for you to not be using the very latest version available.
