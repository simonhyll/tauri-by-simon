...
<SimonSays title="If it isn't documented it doesn't exist">
...
This of course means that more often than not you're just a glorified search enginge, but it helps people help themselves and drastically improves the projects likelihood if surviving the test of time.
</SimonSays>
