---
title: Welcome!
description: Articles on getting started with the site and Tauri in general.
sidebar:
  order: 0
  label: Overview
hero:
  ...
  actions:
    - text: Download the app
      link: https://github.com/simonhyll/tauri-by-simon/releases
      icon: external
      variant: primary
---
...
<img src="/me.jpeg" alt="A picture of Simon Hyll!" style="width: 50%;float:left;padding:0 20px 0 0;" />
